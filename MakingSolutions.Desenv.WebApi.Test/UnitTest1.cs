...
namespace MakingSolutions.Desenv.WebApi.Test
{
    [TestClass]
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7299/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7299/api/CriarTokenIdentity";
